  ...
  return (
    <div className="border-b border-border last:border-0">
      ...
      >
        <h3
          className={cn(
            "text-[18px] md:text-[20px] font-semibold leading-[1.3] transition-colors duration-200 schibsted-grotesk",
      ...
      >
        <p className="text-[16px] text-[#4E5B7D] leading-[1.6] schibsted-grotesk max-w-[1000px]">
          {answer}
        </p>
      </div>
    </div>
    ...
    <section className="bg-white py-[60px] md:py-[100px] px-4">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mb-[40px] md:mb-[60px] text-center">
          <h2 className="text-[32px] md:text-[50px] font-bold text-[#020D2C] leading-tight schibsted-grotesk tracking-tight">
        ...
        <div className="mx-auto max-w-[950px]">
          ...
          <div className="mt-[48px] flex justify-center">
            <button className="inline-flex h-[45px] items-center justify-center rounded-[12px] border border-[#EFF4FF] bg-white px-[24px] py-[12px] text-[16px] font-medium text-[#195AFF] shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all hover:bg-[#EFF4FF] schibsted-grotesk">
              Show More
            </button>
          </div>
        </div>

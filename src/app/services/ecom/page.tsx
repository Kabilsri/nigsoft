...
export default function EcomServicesPage() {
  ...
  const ecommerceFaqs = [
    {
      question: "How do you handle high traffic spikes during sales?",
      answer: "Our e-commerce solutions are built on auto-scaling cloud infrastructure (AWS/Vercel) that automatically allocates resources during peak loads, ensuring your site stays fast and responsive during high-volume sales events."
    },
    {
      question: "Will my online store work well on mobile devices?",
      answer: "We follow a 'Mobile-First' commerce philosophy. Your store will feature optimized touch interfaces, fast-loading mobile pages, and seamless mobile checkout experiences to capture the growing mobile shopper market."
    },
    {
      question: "Can I sell internationally with multiple currencies?",
      answer: "Yes, we implement multi-currency support, localized tax calculation, and international shipping logic to help you expand your footprint and sell to customers globally with a localized feel."
    },
    {
      question: "What kind of analytics will I have access to?",
      answer: "We integrate comprehensive tracking (Google Analytics 4, Hotjar) and custom dashboards that show you conversion rates, average order value, cart abandonment reasons, and individual customer journeys."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <ServiceHero
        ...
        imageAlt="E-commerce Website Development - Online Store Solutions"
